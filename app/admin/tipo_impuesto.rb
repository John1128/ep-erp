ActiveAdmin.register TipoImpuesto do

    config.clear_action_items!
  
    # Parámetros
    resource_name = I18n.t("tipo_impuesto.resource_name")
    resource_title = I18n.t("tipo_impuesto.resource_title")
  
    menu label: resource_name, parent: "Config", priority: 7
    ...
    breadcrumb do
        [
          ...
          link_to(resource_title, {controller: "tipo_impuestos"})
        ]   
    end 
    ...
    index title: resource_title do
        ...
        column I18n.t('tipo_impuesto.descripcion') do |r|
            r.descripcion
        end 
        actions
    end  
