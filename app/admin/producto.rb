ActiveAdmin.register Producto do
    ...
    # Parámetros
    resource_name = I18n.t("producto.resource_name")
    resource_title = I18n.t("producto.resource_title")
  
    menu label: resource_name, parent: "Config", priority: 6
    ...
    breadcrumb do
        [
          ...
          link_to(resource_title, {controller: "productos"})
        ]   
    end 
    ...
    index title: resource_title do
        id_column
        column I18n.t('producto.codigo_sat') do |r|
            r.codigo_sat
        end 
        column I18n.t('producto.descripcion') do |r|
            r.descripcion
        end 
        actions
    end  
    ...
    # Filtros
    filter :codigo_sat, label: I18n.t('producto.codigo_sat')
    filter :descripcion, label: I18n.t('producto.descripcion')

    show title: I18n.t("active_admin.details", model: resource_name) do |form|
        panel resource_name do
          attributes_table_for form do
            row I18n.t('producto.codigo_sat') do |f|
              f.codigo_sat
            end
            row I18n.t('producto.descripcion') do |f|
              f.descripcion
            end
